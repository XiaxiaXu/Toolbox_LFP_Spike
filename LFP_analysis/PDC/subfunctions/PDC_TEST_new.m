...
%                3 == Baccal?& Sameshima (2001) 5 variables linear model
...
%===========================#
    ...
    chLabels  = {'tha';'cor'}; %<***> Example (1)
    strTitle2 = 'Two independent series '; %Title info
...
%    Analysis parameters    /
%===========================#
nFreqs = 100; %<***> number of points on frequency scale; 
...
maxIP =50; % maxIP - externally defined maximum IP %<***>
...
%==================
alpha = 0;        %<***> Significance level for PDC null hypothesis 
...
%<***> Usually half of sampling frequency = Nyquist frequency
...
% The following "for loop"  thourgh flgColor values, 0 and 1, and yields a
% pair of plots, one without and other with color scale rearrangment option.
...
% light-purple-background shows very fine detail of small, usualy not
