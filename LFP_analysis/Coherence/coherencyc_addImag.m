function [C,phi,S12,S1,S2,f,confC,phistd,Cerr]=coherencyc_addImag(data1,data2,params)
...
C12=S12./sqrt(S1.*S2);
C.abs_RealImag=abs(C12);  %2016.11.15 Xiaxia 
C.abs_Imag=abs(imag(C12));  % 2016.11.15 Xiaxia  image Coherence
phi=angle(C12);
if nargout>=9; 
