...
function [time, signal, fs] = nlx_load_Opto(experiment, CSC, ExtractModeArray, downsampling_factor, save_data,Path)
...
%% Script
dir_name = dir(strcat(experiment.path,experiment.name,'*'));
...
fs=str2double(Header{15,1}(end-5:end));
